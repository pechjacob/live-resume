    ...
    <div className="flex flex-col space-y-8 p-6 md:pr-8 text-center md:text-left h-full relative print:text-black">
      ...
      <div className="flex flex-col items-center md:items-start gap-4">
        ...
        >
          ...
          <div
            className="print:hidden w-full h-full rounded-full overflow-hidden border-4 border-gray-600 dark:border-gray-300 hover:shadow-[0_0_30px_rgba(0,255,0,0.6)] shadow-xl relative z-10 cursor-pointer transition-all duration-300 transform hover:scale-105"
          >
